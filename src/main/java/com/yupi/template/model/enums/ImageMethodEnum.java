...
public enum ImageMethodEnum {
    ...
    /**
     * DashScope 通义万相 AI 生图
     */
    DASHSCOPE("DASHSCOPE", "通义万相 AI 生图", true, false),

    /**
     * Hugging Face AI 生图（FLUX.1 等模型）
     */
    HUGGINGFACE("HUGGINGFACE", "Hugging Face AI 生图", true, false),
    ...
    /**
     * 聚合搜索（Pexels + Unsplash + 智能优化）
     */
    AGGREGATED("AGGREGATED", "智能聚合搜索", false, false),
